...
import static ru.iteco.fmhandroid.ui.Steps.UserAuthorizationSteps.EmptyLoginPasswordMessage;
import static ru.iteco.fmhandroid.ui.Steps.UserAuthorizationSteps.InvalidLoginMessage;
...
public class UserAuthorizationTest {
    ...
    public void shouldNotLogInIfTheLoginFieldIsEmpty() {
        userAuthorizationSteps.validPassword();
        userAuthorizationSteps.checkNotificationText(EmptyLoginPasswordMessage, decorView);
    ...
    public void shouldNotLogIfLoginDoesNotExist() {
        ...
        userAuthorizationSteps.checkNotificationText(InvalidLoginMessage, decorView);
        userAuthorizationPage.headline.check(matches(isDisplayed()));
        homePagePage.logo.check(matches(not(isDisplayed())));
    }
